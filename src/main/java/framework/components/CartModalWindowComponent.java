...
public class CartModalWindowComponent {
  ...
  public CartModalWindowComponent(WebElement container) {
    this.modalTitle = container.findElement(By.xpath(
        "//h4[@id='myModalLabel']")).getText().substring(1);
    this.productImage = container.findElement(By.xpath(
        "//div[@class='col-md-6']/img"));
    this.productName = container.findElement(By.xpath(
        "//div[@class='col-md-6']/h6[@class='h6 product-name']"));
    this.productNameText = productName.getText();
    this.productPriceEl = container.findElement(By.xpath(
        "//div[@class='col-md-6']/p[@class='product-price']"));
    this.productPrice = getDigits(productPriceEl);
    this.selectedOptions = container.findElement(By.xpath(
        "//div[@class='col-md-6']/span/strong")).getText();
    this.selectedQuantity = container.findElement(By.xpath(
        "//div[@class='col-md-6']//span[@class='product-quantity']/strong"));
    this.selectedQuantityInt = getDigits(selectedQuantity);
    this.cartProductCountsText = container.findElement(By.xpath(
        "//div[@class='cart-content']//p[@class='cart-products-count']")).getText();
    this.subTotalPriceEl = container.findElement(By.xpath(
        "//div[@class='cart-content']//span[@class='subtotal value']"));
    this.subTotalPrice = getDigits(subTotalPriceEl);
    this.shippingValueEl = container.findElement(By.xpath(
        "//div[@class='cart-content']//span[@class='shipping value']"));
    this.shippingValue = getDigits(shippingValueEl);
    this.totalSumEl = container.findElement(By.xpath(
        "//div[@class='cart-content']//span[@class='value']"));
